...
#torch.save(sketch_matrix01,'/media/tiantong/Drive/Xuelu/CUB_200_2011/bilinear-cnn1/sketch_matrix1.pth')
#torch.save(sketch_matrix02,'/media/tiantong/Drive/Xuelu/CUB_200_2011/bilinear-cnn1/sketch_matrix2.pth')
sketch_matrix01 = torch.load('/cvdata/xuelu/CUB_200_2011/bilinear-cnn1/src/sketch_matrix1.pth')
sketch_matrix02 = torch.load('/cvdata/xuelu/CUB_200_2011/bilinear-cnn1/src/sketch_matrix2.pth')
#pdb.set_trace()
...
# Save model onto disk.
                torch.save(self._net.state_dict(),
                           os.path.join('/cvdata/xuelu/CUB_200_2011/bilinear-cnn1/src/model',
                                        'd8192ft_vgg_16_epoch_%d.pth' % (t + 1)))
...
def main():
    ...
    path = {
        'model': os.path.join(project_root, 'model', 'd8192_vgg_16_epoch_61.pth'),
    }
    for d in path:
        if d == 'model':
